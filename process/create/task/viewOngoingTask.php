<?php
	...
	else
	{
        ...
        '<tr>
            ...
            <td>
							<a href="../../../process/create/task/holdTask.php?id='.$task_id.'"><button class="form-link-f">Hold</button></a>
							<a href="../../../process/create/task/completeTask.php?id='.$task_id.'"><button class="form-link-f">Complete</button></a>
					  </td>
          </tr>';
        }
	}
