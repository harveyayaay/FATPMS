<?php
	...
	while($result_emp_data = $result_emp->fetch(PDO::FETCH_ASSOC))
	{
		...
		echo '<td class="dash-td">'.$qa_set.'</td>';
		echo '<td class="dash-td">'.$esc_set.'</td>';
		// echo '<td><input type="" name="" value="0" oninput="changeTotal()" id="qa" class=fill-info-form placeholder="Input Value"></td>';
		// echo '<td><input type="" name="" value="0" oninput="changeTotal()" id="esc" class=fill-info-form placeholder="Input Value"></td>';

		// echo '<td><input type="" name="" value="" id="total" class=account-info-form></td>';
		
		echo '<td class="dash-td">'.$result_task_data['countvol'].'</td>';
